...
export default function PlacementDrivesLoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (user) {
      if (user.role !== "placement-drives" && user.role !== "admin") {
        setError("Access denied. This account does not have placement drives access.")
        return
      }
      ...
      if (user.role === "admin") {
        ...
        navigate("/placement-drives/dashboard")
      }
    } else {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Manage placement drives and registrations</p>
        </div>
        ...
        <Card className="border border-gray-200 shadow-sm bg-white p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600">Sign in to your placement drives account</p>
          </div>
