              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
                ...
                <div className="flex items-center gap-2 bg-gray-100 rounded-lg p-1">
                  <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${viewMode === "report"
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${viewMode === "insights"
                      ? "bg-white text-blue-600 shadow-sm"
                      : "text-gray-600 hover:text-gray-900"
                      }`}
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-2 bg-gray-100 rounded-lg p-1">
                        <button
                          ...
                          className={`px-3 py-1 rounded-md text-sm font-medium transition-all ${salaryView === "salary"
                            ? "bg-white text-blue-600 shadow-sm"
                            : "text-gray-600 hover:text-gray-900"
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-3 py-1 rounded-md text-sm font-medium transition-all ${salaryView === "stipend"
                            ? "bg-white text-blue-600 shadow-sm"
                            : "text-gray-600 hover:text-gray-900"
                            }`}
                        >
